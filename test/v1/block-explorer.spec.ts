...
import { ROOTSTOCK_MAINNET_PROTOCOL_NETWORK } from '../../src/v1/protocol/RootstockProtocol'

// use chai-as-promised plugin
chai.use(chaiAsPromised)
const expect = chai.expect

const blockExplorers: AirGapBlockExplorer[] = [new EtherscanBlockExplorer(ROOTSTOCK_MAINNET_PROTOCOL_NETWORK.blockExplorerApi)]

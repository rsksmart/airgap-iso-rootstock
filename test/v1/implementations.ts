...
import { RootstockBaseProtocol } from '../../src/v1/protocol/RootstockBaseProtocol'
import { RootstockUnits } from '../../src/v1/types/protocol'
...
interface ProtocolHTTPStub<
  ...
  _EthereumProtocol extends RootstockBaseProtocol<_Units> = RootstockBaseProtocol<_Units>
> {
...
> {
  ...
  public abstract txs: {
    ...
    fee: Amount<RootstockUnits>
    properties?: string[]
    unsignedTx: RootstockUnsignedTransaction
    signedTx: RootstockSignedTransaction
  }[]

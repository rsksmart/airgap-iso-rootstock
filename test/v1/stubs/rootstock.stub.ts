...
import { RootstockUnits } from '../../../src/v1'
import { AirGapNodeClient } from '../../../src/v1'
import { ProtocolHTTPStub, TestProtocolSpec } from '../implementations'

export class RootstockProtocolStub implements ProtocolHTTPStub {
  ...
  public async noBalanceStub(testProtocolSpec: TestProtocolSpec) {
    sinon
      ...
      .returns(Promise.resolve({ total: { value: '0', unit: 'blockchain' } } as Balance<RootstockUnits>))
    sinon
      .stub(AirGapNodeClient.prototype, 'estimateTransactionGas')
      .withArgs(testProtocolSpec.wallet.addresses[0])
      .returns(Promise.resolve(new BigNumber('0x5208')))
